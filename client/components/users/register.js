              ...
              <div className="panel-body">
                <form onSubmit={this.onSubmit} id="loginForm">
                  <div className="form-group">
                    ...
                    <input type="text" ref='username' placeholder="你的用户名" title="请输入用户名" className="form-control" />
                  </div>
                  <div className="form-group">
                    <label className="control-label">手机号</label>
                    <input type="text" ref='phone' title="请输入手机号" className="form-control" />
                    <button className='btn btn-default'>发送验证码</button>
                  </div>
                  <div className="form-group">
                    <label className="control-label">验证码</label>
                    <input type="text"  ref='verifyCode' title="请输入手机验证码" className="form-control" />
                  </div>
                  <div className="form-group">
