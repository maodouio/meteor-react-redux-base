...
export default (domain, dispatch, uploadingPDF, addPDF, uploadedPDF) => {
  return (browse_button) => {
    Meteor.call('files.token', function (err, uptoken) {
      if (err) {
        alert('初始化图片上传组件失败')
      } else {
        Qiniu.uploader({
          ...
          init: {
            ...
            'FileUploaded': function (up, file, info) {
              ...
              dispatch(addPDF(file.name, sourceLink))
              dispatch(uploadedPDF())
            },
